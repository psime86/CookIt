...
export default {
  ...
  sendUserToDB: function (facebookUserData) {
    return axios({
      method: 'POST',
      url: 'http://192.168.1.8:5000/api/user',
      headers: {
        Accept: 'application/json',
        'Content-Type': 'application/json',
      },
  ...
  addFavRecipeToDBAndUser: function (recipeObject) {
    return axios({
      method: 'POST',
      url: 'http://192.168.1.8:5000/api/recipe',
      headers: {
        Accept: 'application/json',
        'Content-Type': 'application/json',
      },
  ...
  addRecipeGroceryListToDBAndUser: function (groceryListObject) {
    return axios({
      method: 'POST',
      url: 'http://192.168.1.8:5000/api/grocery',
      headers: {
        Accept: 'application/json',
        'Content-Type': 'application/json',
      },
  ...
  findUser: function (id) {
    ...
    return axios({
      method: 'GET',
      url: 'http://192.168.1.8:5000/api/findUser/' + id,
      headers: {
        Accept: 'application/json',
        'content-type': 'application/json',
      },
  ...
  deleteRecipeFromUser: function (deleteDataObject) {
    return axios({
      method: 'DELETE',
      url: 'http://192.168.1.8:5000/api/deleteFavRecipe',
      headers: {
        Accept: 'application/json',
        'Content-Type': 'application/json',
      },
  ...
  deleteGroceryListFromUser: function (deleteDataObject) {
    return axios({
      method: 'DELETE',
      url: 'http://192.168.1.8:5000/api/deleteGroceryList',
      headers: {
        Accept: 'application/json',
        'Content-Type': 'application/json',
      },
